...
\end{table}		
		...
		\begin{table}[!h]
\centering
\caption{Kodowanie źródła błędu.}
\label{tab_dtc_interpret}
\begin{tabular}{|c|c|c|}
\hline
\textbf{\begin{tabular}[c]{@{}c@{}}Pierwsza cyfra\\ odpowiedzi\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Zakodowany\\ identyfikator\end{tabular}} & \textbf{Opis}                                                                               \\ \hline
0                                                                            & P0                                                                          & \begin{tabular}[c]{@{}c@{}}Kody układu napędowego \\ zdefiniowane w normie SAE\end{tabular} \\ \hline
1                                                                            & P1                                                                          & \begin{tabular}[c]{@{}c@{}}Kody zdefiniowane\\ przez producenta\end{tabular}                \\ \hline
2                                                                            & P2                                                                          & \begin{tabular}[c]{@{}c@{}}Kody zdefiniowane\\ w normie SAE\end{tabular}                    \\ \hline
3                                                                            & P3                                                                          & \begin{tabular}[c]{@{}c@{}}Kody zdefiniowane\\ przez producenta\end{tabular}                \\ \hline
4                                                                            & C0                                                                          & \begin{tabular}[c]{@{}c@{}}Kody podwozia\\ zdefiniowane w normie SAE\end{tabular}           \\ \hline
5                                                                            & C1                                                                          & \begin{tabular}[c]{@{}c@{}}Kody zdefiniowane\\ przez producenta\end{tabular}                \\ \hline
6                                                                            & C2                                                                          & \begin{tabular}[c]{@{}c@{}}Kody zdefiniowane\\ przez producenta\end{tabular}                \\ \hline
7                                                                            & C3                                                                          & \begin{tabular}[c]{@{}c@{}}Zarezerwowane dla\\ przyszłych zastosowań\end{tabular}           \\ \hline
8                                                                            & B0                                                                          & \begin{tabular}[c]{@{}c@{}}Kody zdefiniowane \\ w normie SAE\end{tabular}                   \\ \hline
9                                                                            & B1                                                                          & \begin{tabular}[c]{@{}c@{}}Kody zdefiniowane \\ przez producenta\end{tabular}               \\ \hline
A                                                                            & B2                                                                          & \begin{tabular}[c]{@{}c@{}}Kody zdefiniowane \\ przez producenta\end{tabular}               \\ \hline
B                                                                            & B3                                                                          & \begin{tabular}[c]{@{}c@{}}Zarezerwowane dla \\ przyszłych zastosowań\end{tabular}          \\ \hline
C                                                                            & U0                                                                          & \begin{tabular}[c]{@{}c@{}}Kody sieci zdefiniowane \\ w normie SAE\end{tabular}             \\ \hline
D                                                                            & U1                                                                          & \begin{tabular}[c]{@{}c@{}}Kody zdefiniowane \\ przez producenta\end{tabular}               \\ \hline
E                                                                            & U2                                                                          & \begin{tabular}[c]{@{}c@{}}Kody zdefiniowane \\ przez producenta\end{tabular}               \\ \hline
F                                                                            & U3                                                                          & \begin{tabular}[c]{@{}c@{}}Zarezerwowane dla \\ przyszłych zastosowań\end{tabular}          \\ \hline
\end{tabular}
\end{table}
